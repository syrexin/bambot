...
module.exports = class FeedbackCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Sends a message to the Bam Bot\'s Support Server feedback channel.',
      type: client.types.MISC,
      examples: ['feedback We love xtor!']
    });
  }
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Bot Support Server](https://discord.gg/9rFWERA) to further discuss your feedback.
      `) 
