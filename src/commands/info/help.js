  ...
  run(message, args) {
    ...
    if (
      ...
      embed // Build specific command help embed
        ...
        .setThumbnail('https://media.discordapp.net/attachments/745857341005758566/768519816784379924/standard_4.gif')
      ...
      embed // Build help embed
        ...
        .setTimestamp()
        .setImage('https://media.discordapp.net/attachments/745857341005758566/768519816784379924/standard_4.gif')
        .setColor('#f342ff');
